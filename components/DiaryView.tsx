...
> 
  ...
  <div className="text-xs font-extrabold tracking-[0.2em] text-muted text-white">
    Coach's Advice
  </div>
  ...
  {coachTipLoading ? (
    ...
    <div className="mt-3 rounded-2xl bg-white/5 border border-white-400 p-4 text-white/80 font-semibold text-sm leading-relaxed">
